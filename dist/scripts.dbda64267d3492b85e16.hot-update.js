...
class Notes {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#my-notes').on('click', '.delete-note', this.deleteBtn); // this.ul.addEventListener('click', (e) => {
...
//# sourceMappingURL=scripts.dbda64267d3492b85e16.hot-update.js.map