...
class Notes {
  ...
  createNote(e) {
    let newPost = {
      'title': jquery__WEBPACK_IMPORTED_MODULE_0___default()('.new-title-note').val(),
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      success: response => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('<li>Data goes here</li>').prependTo('#my-notes');
        console.log('success');
        console.log(response);
      },
      error: response => {
...
//# sourceMappingURL=scripts.eb8b0420ba33eaa96598.hot-update.js.map