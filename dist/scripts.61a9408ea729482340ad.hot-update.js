...
class Notes {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.ul).on('click', '.edit-note', this.editNote(e).bind(this));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.ul).on('click', '.update-note', this.updateNote(e).bind(this));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.ul).on('click', '.create-note', this.createNote(e));
  } // Methods
...
//# sourceMappingURL=scripts.61a9408ea729482340ad.hot-update.js.map