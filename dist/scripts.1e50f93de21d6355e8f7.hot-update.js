...
class Notes {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.editBtn).on('click', '.edit-note', this.editNote(e)); // this.editBtn.forEach( (btn) => {
    //   btn.addEventListener('click', (e) =>{
    //     this.editNote(e)
    //   })
    // })
...
//# sourceMappingURL=scripts.1e50f93de21d6355e8f7.hot-update.js.map