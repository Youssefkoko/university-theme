...
class Notes {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.editBtn).on('click', '.edit-note', this.editNote(e).bind(this)); // this.editBtn.forEach( (btn) => {
    //   btn.addEventListener('click', (e) =>{
    //     this.editNote(e)
    //   })
    // })
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.updateBtn).on('click', '.update-note', this.updateNote(e).bind(this)); // this.updateBtn.addEventListener('click', (e) =>{
    //     this.updateNote(e)
    //   })

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.submitBtn).on('click', '.create-note', this.createNote(e));
  } // Methods
...
//# sourceMappingURL=scripts.bb5162bd8de2d162fac6.hot-update.js.map