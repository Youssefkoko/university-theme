...
class Notes {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#my-notes').on('click', '.delete-note', this.deleteNote); // this.ul.addEventListener('click', (e) => {
...
//# sourceMappingURL=scripts.edd31440facc0eab084c.hot-update.js.map