...
class Notes {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.updateBtn).on('click', '.delete-note', this.updateNote(e).bind(this)); // this.updateBtn.addEventListener('click', (e) =>{
    //     this.updateNote(e)
    //   })

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.submitBtn).on('click', '.delete-note', this.createNote(e));
  } // Methods
...
//# sourceMappingURL=scripts.fe9ecd647920b6aedc02.hot-update.js.map