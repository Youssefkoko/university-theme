    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.getJSON(themeData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), results => {
      ...
      <div class="row">
        ...
        <div class="one-third">
          ...
          ${results.programs.length ? `<ul class="link-list min-list" >` : `<p>No Search Found.</p>`}
        ...
        ${results.programs.length ? `</ul>` : ''}
          ...
          ${results.professors.length ? `<ul class="link-list min-list" >` : `<p>No Search Found.</p>`}
...
//# sourceMappingURL=scripts.d428014c3ef243044eed.hot-update.js.map