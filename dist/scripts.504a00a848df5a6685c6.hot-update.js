...
class Notes {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.ul).on('click', '.delete-note', this.deleteNote); // this.ul.addEventListener('click', (e) => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.editBtn).on('click', '.delete-note', this.editNote(e)); // this.editBtn.forEach( (btn) => {
    //   btn.addEventListener('click', (e) =>{
    //     this.editNote(e)
    //   })
    // })
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.updateBtn).on('click', '.delete-note', this.updateNote(e)); // this.updateBtn.addEventListener('click', (e) =>{
    //     this.updateNote(e)
    //   })

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.submitBtn).on('click', '.delete-note', this.createNote(e)); // this.submitBtn.addEventListener('click', (e) =>{
    //     this.createNote(e)
    //   })
  } // Methods
...
//# sourceMappingURL=scripts.504a00a848df5a6685c6.hot-update.js.map